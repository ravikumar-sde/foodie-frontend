...
export default function CartPage() {
    const { cart, addToCart, removeFromCart, getTotalQuantity } = useCart();
    const { id } = useParams();
        ...
        return (
            <div className="cart-page-container">
                <div className="cart-header">
                    <button className="back-btn" onClick={() => navigate(`/restaurants/${id}/online-order`)}>
                ...
                <div className="empty-cart">
                    ...
                    <button className="browse-menu-btn" onClick={() => navigate(`/restaurants/${id}/online-order`)}>
                        Browse Menu
                    </button>
                </div>
            </div>
